...
import org.ruikun.modules.comment.service.ICommentService;
import org.ruikun.modules.points.service.IPointsService;
import org.ruikun.modules.comment.vo.CommentVO;
...
public class CommentServiceImpl implements ICommentService {
    ...
    public Long createComment(Long userId, CommentCreateDTO commentDTO) {
        ...
        wrapper.eq(OrderItem::getOrderId, commentDTO.getOrderId())
               .eq(OrderItem::getProductId, commentDTO.getProductId());
