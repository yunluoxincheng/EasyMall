package org.ruikun.modules.admin.controller;
...
import org.ruikun.modules.admin.dto.CommentQueryDTO;
...
import org.ruikun.modules.admin.vo.AdminCommentPageVO;
import org.ruikun.modules.admin.vo.AdminCommentVO;
...
public class AdminCommentController {
    ...
    private Map<Long, String> getUserIdToNicknameMap(List<Long> userIds) {
        ...
        return userMapper.selectBatchIds(userIds).stream()
                .collect(Collectors.toMap(
                        org.ruikun.modules.user.entity.User::getId,
    ...
    private Map<Long, String> getProductIdToNameMap(List<Long> productIds) {
        ...
        return productMapper.selectBatchIds(productIds).stream()
                .collect(Collectors.toMap(
                        org.ruikun.modules.product.entity.Product::getId,
                        org.ruikun.modules.product.entity.Product::getName
                ));
    }
}
