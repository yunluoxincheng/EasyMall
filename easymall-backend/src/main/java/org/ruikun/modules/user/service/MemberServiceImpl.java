...
import org.ruikun.modules.user.mapper.MemberLevelMapper;
...
public class MemberServiceImpl implements IMemberService {
    ...
    private final org.ruikun.modules.coupon.mapper.CouponTemplateMapper couponTemplateMapper;
    ...
    public void checkAndUpgradeMember(Long userId) {
        ...
        if (!targetLevel.getLevel().equals(user.getLevel())) {
            ...
            // 升级后自动发放该等级的专属优惠券
            try {
                LambdaQueryWrapper<org.ruikun.modules.coupon.entity.CouponTemplate> wrapper = new LambdaQueryWrapper<>();
                wrapper.eq(org.ruikun.modules.coupon.entity.CouponTemplate::getType, 4) // 4-会员专属券
                        .eq(org.ruikun.modules.coupon.entity.CouponTemplate::getStatus, 1) // 上架中
                        .eq(org.ruikun.modules.coupon.entity.CouponTemplate::getMemberLevel, targetLevel.getLevel()) // 对应等级
                        .last("LIMIT 1");
                org.ruikun.modules.coupon.entity.CouponTemplate memberCoupon = couponTemplateMapper.selectOne(wrapper);
