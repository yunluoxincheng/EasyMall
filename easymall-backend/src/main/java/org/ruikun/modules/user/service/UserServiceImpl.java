...
public class UserServiceImpl implements IUserService {
    ...
    public void register(UserRegisterDTO registerDTO) {
        ...
        // 自动发放新人专享券
        try {
            LambdaQueryWrapper<org.ruikun.modules.coupon.entity.CouponTemplate> couponWrapper = new LambdaQueryWrapper<>();
            couponWrapper.eq(org.ruikun.modules.coupon.entity.CouponTemplate::getType, 3) // 3-新人专享券
                    .eq(org.ruikun.modules.coupon.entity.CouponTemplate::getStatus, 1) // 上架中
                    .orderByAsc(org.ruikun.modules.coupon.entity.CouponTemplate::getSortOrder)
                    .last("LIMIT 1");
            org.ruikun.modules.coupon.entity.CouponTemplate newbieCoupon = couponTemplateMapper.selectOne(couponWrapper);
