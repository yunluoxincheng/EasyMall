...
- [x] 13.1 验证所有页面路由正确配置且侧边栏高亮正确
- [x] 13.2 验证 Token 过期后自动跳转登录页
- [x] 13.3 验证普通用户登录后被拒绝进入后台
- [x] 13.4 验证所有页面的加载状态（loading）和错误提示
- [x] 13.5 验证 `npm run build` 构建成功
- [x] 13.6 验证 `npm run dev` 启动成功且代理正常
